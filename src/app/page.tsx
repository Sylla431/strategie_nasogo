...
const services = [
  ...
  {
    id: "objectif-rentabilite",
    name: "Objectif Rentabilité",
    slug: "objectif-rentabilite",
    description: "Coaching personnalisé de 2 mois pour atteindre un objectif de rentabilité et multiplier vos gains.",
    cover: "/images/rentabilitev2.jpg",
    price: 500000,
    featured: false,
    available: true,
